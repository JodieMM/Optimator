...
namespace Animator
{
    public partial class PiecesForm : Form
    {
        ...
        private void ApplySegmentFully()
        {
            ...
            ConvertVariablesToData(90, 180, 0, 90, rCoords, oCoords, bCoords, joins, solid);
            ConvertVariablesToData(180, 270, 0, 90, oCoords, rCoords, tCoords, joins, solid);
            ConvertVariablesToData(270, 360, 0, 90, rCoords, oCoords, bCoords, joins, solid);

            ConvertVariablesToData(0, 90, 90, 180, tCoords, bCoords, oCoords, joins, solid);
            ConvertVariablesToData(90, 180, 90, 180, bCoords, tCoords, rCoords, joins, solid);
            ConvertVariablesToData(180, 270, 90, 180, tCoords, bCoords, oCoords, joins, solid);
            ConvertVariablesToData(270, 360, 90, 180, bCoords, tCoords, rCoords, joins, solid);

            ConvertVariablesToData(0, 90, 180, 270, oCoords, rCoords, tCoords, joins, solid);
            ConvertVariablesToData(90, 180, 180, 270, rCoords, oCoords, bCoords, joins, solid);
            ConvertVariablesToData(180, 270, 180, 270, oCoords, rCoords, tCoords, joins, solid);
            ConvertVariablesToData(270, 360, 180, 270, rCoords, oCoords, bCoords, joins, solid);

            ConvertVariablesToData(0, 90, 270, 360, tCoords, bCoords, oCoords, joins, solid);
            ConvertVariablesToData(90, 180, 270, 360, bCoords, tCoords, rCoords, joins, solid);
            ConvertVariablesToData(180, 270, 270, 360, tCoords, bCoords, oCoords, joins, solid);
            ConvertVariablesToData(270, 360, 270, 360, bCoords, tCoords, rCoords, joins, solid);
        }
